...
<head>
  ...
  <link rel="stylesheet" href="{prefix}assets/styles.css?v=12">
...
home = head("ПРОМГАЗ — технические газы в Чебоксарах", "Продажа технических газов в Чебоксарах. ПРОМГАЗ: более 20 лет на рынке. Подбор продукции и согласование поставки.", "")
home += header("")
home += f'''
<main id="main">
<section class="hero">
 <div class="container hero-grid">
  ...
  <div class="hero-media"><div class="applications" aria-label="Направления поставок и применение">
    <div class="application"><div class="application-formula" aria-hidden="true">Ar<span>+ CO₂</span></div><div><h2>Промышленность</h2><p>Сварка, резка и обработка металла</p><span class="application-components">Аргон · Кислород · Смеси</span></div></div>
    <div class="application"><div class="application-formula" aria-hidden="true">O₂</div><div><h2>Медицина</h2><p>Снабжение медицинских учреждений</p><span class="application-components">Кислород · Закись азота</span></div></div>
    <div class="application"><div class="application-formula" aria-hidden="true">N₂<span>+ CO₂</span></div><div><h2>Пищевая отрасль</h2><p>Напитки, упаковка и хранение</p><span class="application-components">Азот · Углекислота · Смеси</span></div></div>
  </div><div class="dealer-card"><img src="assets/linde-logo.png" alt="Linde" width="150" height="80"><div><strong>Официальный дилер Linde</strong><span>Продукция международного производителя</span></div></div></div>
 </div>
</section>
<div id="company" class="facts"><div class="container facts-grid"><div><strong>20+ лет</strong><span>опыт поставок</span></div><div><strong>Подбор</strong><span>Марка и состав под вашу задачу</span></div><div><strong>Получение</strong><span>Самовывоз или доставка по согласованию</span></div></div></div>
<section id="catalog" class="section catalog-section"><div class="container"><div class="section-heading"><div><span class="eyebrow">КАТАЛОГ</span><h2>Продукция</h2></div><p>Выберите раздел и нужную позицию. Стоимость и сроки поставки уточняйте в запросе.</p></div>{catalog()}<div class="catalog-bottom"><p>Есть спецификация или список для закупки?</p><a href="mailto:{EMAIL}" class="text-button">Отправить спецификацию</a></div></div></section>
<section id="services" class="section services-section"><div class="container service-layout"><div class="service-heading"><span class="eyebrow">УСЛОВИЯ ЗАКАЗА</span><h2>Как получить продукцию</h2><p>Можно заказать с баллоном или использовать свой. Согласуем покупку, аренду, заправку или обмен, а затем — способ получения.</p></div><div class="service-list">
...
<main id="main">
  ...
  <section class="container product-order-info"><div><span class="eyebrow">ДЛЯ РАСЧЁТА ЗАКАЗА</span><h2>Уточним детали</h2></div><div><p>{escape(g["note"])}</p><p>Если у вас есть собственные баллоны, сообщите об этом. Возможность заправки или обмена согласуем отдельно.</p><p>Получение — самовывоз или доставка по согласованию. Адрес и схема проезда — в <a href="../index.html#contacts">контактах</a>.</p></div></section>
